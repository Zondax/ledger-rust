...
extern "C" {
    #[doc = " @brief   Performs a modular exponentiation **r = a^e mod n**.\n\n @details This fonction reuses the parameter *a* for intermediate computations,\n          hence requires less memory.\n          *r*, *a* and *n* shall have the same BN size.\n          *r*, *a* and *n* must be different.\n\n @param[out] r     BN index for the result.\n\n @param[in]  a     BN index of the base of the exponentiation.\n                   The BN value is modified during the\n                   computations.\n\n @param[in]  e     Pointer to the exponent.\n\n @param[in]  e_len Length of the exponent buffer.\n\n @param[in]  n     BN index of the modulus.\n\n @return           Error code:\n                   - CX_OK on success\n                   - CX_NOT_LOCKED\n                   - CX_INVALID_PARAMETER\n                   - CX_MEMORY_FULL"]
...
extern "C" {
    #[doc = " This function deletes the application mentioned with its index, as well as all its dependees (the applications which depend on it).\n @param index The index of the the application to suppress."]
...
pub const os_setting_e_OS_SETTING_NFC_ENABLED: os_setting_e = 14;
...
extern "C" {
    #[doc = " Function takes 0 for first call. Returns 0 when timeout has occured. Returned value is passed as argument for next call, acting as a timeout context."]
